...
const Experience: React.FC = () => {
  return (
    <>
      ...
      >
        <div className="h-screen relative flex overflow-hidden flex-col text-left md:flex-row justify-evenly mx-auto items-center">
          <h3 className="pl-[20px] absolute top-28 md:top-42 uppercase tracking-[20px] text-[#87C332] text-2xl text-center">
            Projects
          </h3>
          <div className="h-full pt-32 absolute bottom-5 w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory scrollbar-thin z-20 scrollbar-track-rgb(35,21,59)/20 scrollbar-thumb-[#87C233]/80">
            {projects.map((proj) => (
              <div
                key={proj.name}
                className="w-full flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center px-20 md:px-44 z-20"
              >
                <motion.div
